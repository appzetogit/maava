...
export const updateRestaurantProfile = asyncHandler(async (req, res) => {
  try {
    ...
    if (location) {
      ...
      // Also sync with onboarding step 1 location to prevent overwrites during onboarding flow
      updateData['onboarding.step1.location'] = location;

      console.log('📍 Restaurant location updated and synced with onboarding:', {
        restaurantId,
