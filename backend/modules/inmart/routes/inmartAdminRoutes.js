...
// Remove product from a collection (section) without deleting the product
router.delete('/collections/:collectionIdOrSlug/products/:productIdOrSlug', removeProductFromCollection);
