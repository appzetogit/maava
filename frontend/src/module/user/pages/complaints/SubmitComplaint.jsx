...
export default function SubmitComplaint() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 pb-24">
      {/* Header */}
      <div className="bg-white dark:bg-gray-800 p-4 flex items-center sticky top-0 z-20 shadow-sm border-b dark:border-gray-700">
        <button
          type="button"
          onClick={() => navigate(-1)}
      ...
      {/* Order Info */}
      <div className="bg-white dark:bg-gray-800 mx-4 mt-4 p-4 rounded-xl shadow-sm border dark:border-gray-700">
      ...
      <form onSubmit={handleSubmit} className="mx-4 mt-4 space-y-4">
        ...
        <div>
          ...
          <select
            ...
            className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-[#E23744] focus:border-transparent bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
            required
          >
        ...
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-[#E23744] focus:border-transparent bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500"
            required
            maxLength={200}
          />
        </div>
        ...
        <div>
          ...
          <textarea
            ...
            rows={6}
            className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-[#E23744] focus:border-transparent resize-none bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500"
            required
            maxLength={1000}
          />
