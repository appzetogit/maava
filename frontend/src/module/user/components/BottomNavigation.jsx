...
export default function BottomNavigation() {
  ...
  return (
    <div
      className="md:hidden fixed bottom-0 left-0 right-0 bg-white dark:bg-[#1a1a1a] border-t border-gray-200 dark:border-gray-800 z-50 shadow-lg pb-safe"
    >
      <div className="flex items-center justify-around h-auto px-4 sm:px-6 pb-2">
        {/* Delivery Tab */}
        <Link
          to="/user"
