...
export default function PageNavbar({
  ...
  return (
    <nav
      className={`relative pt-[calc(env(safe-area-inset-top,24px)+32px)] sm:pt-[calc(env(safe-area-inset-top,24px)+36px)] pb-1.5 sm:pb-3 lg:pb-4 ${zIndexClass} w-full px-1 pr-2 sm:px-2 sm:pr-3 md:px-3 lg:px-6 xl:px-8`}
      onClick={onNavClick}
    >
