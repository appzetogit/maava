...
export default function InMartManagement() {
    ...
    const fetchCategories = async () => {
        try {
            ...
            const response = await api.get('/admin/inmart/categories', getAuthConfig())
    ...
    const handleDeleteCategory = async (id) => {
        ...
        try {
            ...
            await api.delete(`/admin/inmart/categories/${id}`, getAuthConfig())
            fetchCategories()
    ...
    const fetchBanners = async () => {
        try {
            ...
            const response = await api.get('/admin/inmart/offer-banners', getAuthConfig())
    ...
    const fetchRestaurantsList = async () => {
        try {
            const response = await api.get('/admin/inmart/restaurants-list', getAuthConfig())
    ...
    const handleDeleteBanner = async (id) => {
        ...
        try {
            ...
            await api.delete(`/admin/inmart/offer-banners/${id}`, getAuthConfig())
            fetchBanners()
    ...
    const fetchStories = async () => {
        try {
            ...
            const response = await api.get('/admin/inmart/stories', getAuthConfig())
    ...
    const handleDeleteStory = async (id) => {
        ...
        try {
            ...
            await api.delete(`/admin/inmart/stories/${id}`, getAuthConfig())
            fetchStories()
    ...
    const tabs = [
        { id: 'categories', label: 'In Mart Categories', icon: Layout },
        { id: 'banners', label: 'In Mart Banners', icon: ImageIcon },
        { id: 'stories', label: 'In Mart Stories', icon: FileText },
    ]
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 mb-6">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-2xl font-bold text-slate-900">In Mart Management</h1>
                            <p className="text-sm text-slate-600 mt-1">Manage in mart categories, banners, and stories</p>
                        </div>
                    </div>
                </div>
