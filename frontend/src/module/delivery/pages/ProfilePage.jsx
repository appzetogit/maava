            ...
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-2">
                <h2 className="text-2xl md:text-3xl font-bold">
                  {loading ? t('delivery.loading', { defaultValue: 'Loading...' }) : profile?.name || t('delivery.delivery_partner', { defaultValue: 'Delivery Partner' })}
                </h2>
      ...
      <div className="px-4 py-6 pb-24 md:pb-6">
        ...
        <div ref={navButtonsRef} className="grid grid-cols-1 gap-3 mb-6">
          ...
          >
            ...
            <span className="text-xs font-medium">{t('delivery.history')}</span>
          </button>
        </div>
        ...
        <div ref={sectionsRef} className="space-y-4">
          ...
          <div>
            ...
            {/* Change Language */}
            <Card
              onClick={() => navigate("/delivery/help/language")}
