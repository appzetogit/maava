...
const ordersTabs = [
  { id: "orders", label: "Orders", icon: ShoppingBag, route: "/restaurant" },
  { id: "inventory", label: "Inventory", icon: Box, route: "/restaurant/inventory" },
  { id: "feedback", label: "Feedback", icon: MessageCircle, route: "/restaurant/feedback" },
  { id: "explore", label: "Explore", icon: Telescope, route: "/restaurant/explore" },
]

const hubTabs = [
  { id: "hub", label: "  Hub  ", icon: Home, route: "/restaurant/to-hub" },
  { id: "growth", label: "Growth", icon: LineChart, route: "/restaurant/hub-growth" },
  { id: "menu", label: "Menu", icon: UtensilsCrossed, route: "/restaurant/hub-menu" },
  { id: "finance", label: "Finance", icon: CreditCard, route: "/restaurant/hub-finance" },
]
        ...
        <div className="flex items-center gap-2 w-full">
          ...
          {isHubMode && (
            <button
              ...
              className="flex flex-col items-center gap-1 bg-black text-white pr-3 py-3 rounded-r-full rounded-l-[12px] shadow-md border border-white/10 active:scale-95"
            >
          ...
          <div className="flex-1">
            <div className={`bg-black border border-white/10 rounded-full py-1.5 px-1 shadow-xl relative ${isHubMode ? "mr-1" : "ml-1"}`}>
                ...
                {tabs.map(tab => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <Icon className={`w-5 h-4 relative z-10 transition-colors duration-300 ease-in-out ${isActive ? "text-black shadow-sm" : "text-gray-400"}`} />
                      <span className={`text-[11px] relative z-10 transition-colors duration-300 ease-in-out ${isActive ? "text-black font-bold" : "text-gray-300"}`}>
                        {tab.label}
                      </span>
                    </motion.button>
                  )
          ...
          {!isHubMode && (
            <button
              onClick={handleToggleMode}
              className="flex flex-col items-center gap-1 bg-black text-white pl-3 py-3 rounded-l-full rounded-r-[12px] shadow-md border border-white/10 active:scale-95"
            >
              <Repeat className="w-4 h-4" />
