                ...
                <div className="relative z-10 w-full flex flex-col items-center">
                  ...
                  {item.badge && (
                    <motion.span
                      ...
                      className="absolute -top-1 -right-1 bg-gradient-to-r from-red-600 to-red-500 text-white text-[9px] font-black px-2 py-0.5 rounded-full shadow-lg shadow-red-200"
                    >
                      {item.badge}
                    </motion.span>
                  )}
            ...
            <div key={section.key}>
              ...
              {index < filteredSections.length - 1 && (
                <motion.div
                  ...
                  className="border-t border-purple-100/30 my-6"
                />
              )}
            </div>
          ))
            ...
            >
              ...
              <div className="px-6 py-6">
                ...
                <button
                  ...
                  className="w-full bg-red-600 hover:bg-red-700 text-white font-extrabold py-4 px-4 rounded-2xl transition-all shadow-md shadow-red-100 active:scale-95"
                >
                  Remove Schedule
                </button>
              </div>
