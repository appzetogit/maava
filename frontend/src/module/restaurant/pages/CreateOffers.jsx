...
import { ArrowLeft, ChevronDown, ChevronRight, Filter, Info, X, Users } from "lucide-react"
              ...
              <div className="">
                {offerGoals.map((goal, index) => (
                  <motion.div
                    ...
                    className="bg-white rounded-2xl p-5 flex items-center gap-4 border border-gray-100 cursor-pointer hover:shadow-lg transition-shadow"
                  >
                    <motion.div
                      className="shrink-0"
