...
export default function Inventory() {
  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA] flex flex-col">
      ...
      <div className=" top-[50px] z-40 px-4 pt-4 pb-4">
                ...
                >
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      ...
                      <p className="text-[11px] text-gray-500 font-medium mb-1">{category.description}</p>
                      <div className="flex items-center justify-between">
                        <div>
                          {category.inStock ? (
                            <div className="flex items-center gap-1.5">
                              <span className="w-1.5 h-1.5 rounded-full bg-green-500 shadow-[0_0_6px_rgba(34,197,94,0.4)]"></span>
                              <p className="text-[10px] text-green-600 font-bold uppercase tracking-wider">In stock</p>
                            </div>
                          ) : (
                            <p className="text-[10px] text-red-500 font-bold uppercase tracking-wider">
                              {getOutOfStockCount(category)}/{category.itemCount} out of stock
                            </p>
                          )}
                        </div>
                      </div>
                              ...
                              <div className="flex items-center gap-2 flex-1">
                                ...
                                <div>
                                  ...
                                  {item.inStock ? (
                                    ...
                                    <p className="text-[10px] text-red-500 font-bold uppercase tracking-wider">Out of stock</p>
                                  )}
                                </div>
                              </div>
                              <div className="flex items-center gap-3">
                                ...
                                <div className="flex items-center gap-4">
                                  <div className="flex flex-col items-center">
                                    <label className="text-[10px] text-gray-400 font-bold uppercase mb-1">Stock</label>
                                    <Switch
                                  ...
                                  <div className="flex flex-col items-center">
                                    <label className="text-[10px] text-gray-400 font-bold uppercase mb-1">Rec.</label>
                                    <button
                  ...
                  <label className="flex items-center justify-between py-4 cursor-pointer">
                    <div className="flex flex-col gap-1 flex-1">
                      ...
                      <p className="text-sm text-gray-500">
                        Item won't be visible to customers on Maava app till you mark it back in stock
                      </p>
                    </div>
                  </label>
                </div>
